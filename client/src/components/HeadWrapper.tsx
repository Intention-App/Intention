...
export const HeadWrapper: React.FC<HeadWrapperProps> = ({ backlink, header, helper, creator, titleChanger, children }) => {
    ...
    return (
        <Box display="grid" gridTemplateRows="100px 1fr" height="100%">
            <Box height={25} padding={4} paddingY={2.5}>
                <Box display="flex" alignItems="center">
                    ...
                    {creator &&
                        <Box marginLeft="auto">
                            <FaPlusCircle
                                style={{ width: 24, height: 24, color: "var(--icon)", cursor: "pointer" }}
                                onClick={creator}
                            />
                        </Box>
                    }
